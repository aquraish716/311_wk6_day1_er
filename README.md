...
- The blue diamond represents a NOT NULL simple attribute

3. How many foreign keys does the "payments" table have? How can you tell?

- The "payments" table has 3 foreign keys. There are two filled red diamonds and 1 not filled red diamond. Red means foreign key.
